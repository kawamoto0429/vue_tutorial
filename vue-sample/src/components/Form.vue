...
onMounted(async () => {
  ...
  data.value = await axios.get(
    "https://vue-example-edef6-default-rtdb.firebaseio.com/surveys.json"
  );
...
const onSubmit = (e: Event) => {
  try {
    // fetch("https://vue-example-edef6-default-rtdb.firebaseio.com/surveys.json", {
    //   method: "POST",
    //   headers: {
